...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-dashed border-surface-strong/60 bg-surface px-4 py-3">
        ...
        <button
          ...
          className="inline-flex items-center rounded-lg border border-surface-strong/60 px-4 py-2 text-sm font-semibold text-muted transition hover:bg-surface disabled:cursor-not-allowed disabled:opacity-60"
        >
